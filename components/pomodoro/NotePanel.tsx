...
export function NotePanel({ isOpen, taskId, onClose }: NotePanelProps) {
  ...
  return (
    <div className="fixed top-0 right-0 bottom-0 w-full sm:w-96 bg-card/95 backdrop-blur-md border-l shadow-xl z-50 flex flex-col transition-all duration-300 ease-in-out">
      {/* Header */}
