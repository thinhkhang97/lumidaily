...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "data-[state=active]:bg-background data-[state=active]:text-foreground text-foreground",
        "inline-flex h-[calc(100%-2px)] flex-1 items-center justify-center gap-grid-1 rounded-lg px-3 py-2 text-base font-medium whitespace-nowrap",
